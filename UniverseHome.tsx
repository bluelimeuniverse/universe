...
import { ArrowRight, Cpu, Globe, Users, Zap, Rocket, Code, BarChart3, Mail, PenTool } from "lucide-react";
...
const UniverseHome = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white overflow-x-hidden font-['Ubuntu'] selection:bg-green-500 selection:text-black">
      <CosmicBackground />
      ...
      <section className="relative h-screen flex items-center justify-center px-6 pt-20">
        <div className="text-center max-w-5xl mx-auto z-10">
          <div className="mb-8 animate-fade-in flex justify-center">
            <img src="public/BluelimeUniverse.png" alt="BlueLime Universe Logo" className="h-[120px] w-[120px] object-contain drop-shadow-[0_0_15px_rgba(0,255,0,0.3)]" />
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 delay-700">
            <Button size="lg" className="bg-green-500 text-black hover:bg-green-400 text-lg px-8 py-6 rounded-none font-bold tracking-wide">
              ENTER THE UNIVERSE <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 text-lg px-8 py-6 rounded-none font-bold tracking-wide">
              EXPLORE APPS
            </Button>
          </div>
        </div>
      ...
      <footer className="bg-black py-12 border-t border-white/10">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <img src="public/BluelimeUniverse.png" alt="BlueLime" className="h-8 w-8 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all" />
